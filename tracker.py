...
# ── Entity list ───────────────────────────────────────────────────────────────
ENTITIES = [
    "Reliance Industries", "TCS", "Tata Consultancy Services",
    "Infosys", "HDFC Bank", "ICICI Bank", "Hindustan Unilever", "HUL",
    "Bharti Airtel", "Airtel", "ITC", "Kotak Mahindra", "Bajaj Finance",
    "Axis Bank", "Wipro", "HCL Technologies", "HCLTech", "Sun Pharma",
    "Maruti Suzuki", "Maruti", "Titan", "Asian Paints", "Ultratech Cement",
    "Nestle India", "Nestle", "Tech Mahindra", "L&T", "Larsen & Toubro",
    "Power Grid", "NTPC", "ONGC", "Coal India", "BPCL", "HPCL",
    "Adani Enterprises", "Adani Ports", "Adani Green", "Adani Total Gas",
    "Adani Power", "Zomato", "Nykaa", "FSN E-Commerce",
    "Paytm", "One97 Communications", "Delhivery", "Vedanta",
    "JSW Steel", "Tata Steel", "Hindalco", "Grasim",
]
